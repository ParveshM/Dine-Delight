...
exports.default = {
    generateMailBody: function (senderData, data) {
        const { restaurantId, userId, restaurantName, userName } = senderData;
        const { name, price, discount } = data;
        const discountPrice = (0, utilityFunctions_1.calculateDiscountedPrice)(price, discount);
        return `<!DOCTYPE html>
        ...
        <tr>
          <td class="pad" style="padding-bottom: 30px; padding-left: 30px; padding-right: 30px;">
            <div class="footer-content">
              <p>You can <a href="#" rel="noopener">update your preferences</a> or <a href="${config_1.default.CLIENT_PORT}/unsubscribe/${restaurantId}/${userId}" rel="noopener">unsubscribe</a> from this list.</p>
